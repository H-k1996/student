<template>
  ...
  >
    ...
    <el-table-column prop="name" label="单价(元)" width="140">
    </el-table-column>

    <el-table-column prop="name" label="数量" width="120"> </el-table-column>
    <el-table-column prop="name" label="规则" width="120"> </el-table-column
    ><el-table-column prop="name" label="存放地点" width="130"> </el-table-column
    >
    ><el-table-column prop="name" label="入库时间" width="120"> </el-table-column

<template>
  ...
  >
    ...
    <el-table-column prop="address" label="是否拥有房产证" width="200"> </el-table-column>
    <el-table-column prop="name" label="产权性质" width="100">
    </el-table-column>

    <el-table-column prop="name" label="房屋坐落" width="90"> </el-table-column>
    <el-table-column prop="name" label="房屋结构"> </el-table-column
    ><el-table-column prop="name" label="层数"> </el-table-column
    ><el-table-column prop="name" label="建筑面积（㎡）">
    </el-table-column
    ><el-table-column prop="name" label="套内建筑面积（㎡）"> </el-table-column
    ><el-table-column prop="name" label="状态"> </el-table-column
    ><el-table-column prop="name" label="变更时间"> </el-table-column
    >
...
<el-dialog title="新增地产" :visible.sync="dialogFormVisible" append-to-body="true">
  <el-form :model="form">
    <el-form-item label="编码" :label-width="formLabelWidth">
     ...
     <el-form-item label="房产名称" :label-width="formLabelWidth">
      <el-input v-model="form.date1" autocomplete="off" style="width:220px"></el-input>
    </el-form-item>
<p>是否拥有房产证：<el-radio v-model="radio" label="1">备选项</el-radio> <el-radio v-model="radio" label="2">备选项</el-radio></p><br>
      
     
    <el-form-item label="房屋坐落：" :label-width="formLabelWidth">
      <el-input v-model="form.date2" autocomplete="off" style="width:220px"></el-input>
    </el-form-item>
    ...
    <el-form-item label="建筑面积：" :label-width="formLabelWidth">
      <el-input v-model="form.desc" autocomplete="off" style="width:220px"></el-input>m²
    </el-form-item>
    <el-form-item label="套内建筑面积：" :label-width="formLabelWidth">
      <el-input v-model="form.desc" autocomplete="off" style="width:220px"></el-input>m²
    </el-form-item>

<template>
  ...
  >
    ...
    <el-table-column prop="address" label="是否拥有房产证"> </el-table-column>
    ...
    ><el-table-column prop="name" label="开始维修时间"> </el-table-column
    ><el-table-column prop="name" label="维修结束时间"> </el-table-column
    >

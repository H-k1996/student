<template>
  ...
  >
    ...
    <el-table-column prop="address" label="土地面积(m²)"> </el-table-column>
    <el-table-column prop="name" label="建筑面积((m²))"> </el-table-column>

    <el-table-column prop="name" label="非建筑面积(m²)"> </el-table-column>

        ...
        ><div class="grid-content bg-purple-dark storageBox">
          ...
          <div class="baikuang">
            ...
            <p>
              ...
              >
                <el-tab-pane label="借入" name="first"
                  ></el-tab-pane
                >
                <el-tab-pane label="挂失" name="second"
                  ></el-tab-pane
                >
                <el-tab-pane label="保修" name="third"
                  ></el-tab-pane
                >
                <el-tab-pane label="报废" name="fourth"
                  ></el-tab-pane
                >
              </el-tabs>
            </p>
...
import JiaoTable from "../../../components/shenpi/jiaoTable"
export default {
  components: {
    Header,
    JiaoTable

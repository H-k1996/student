    ...
    <el-row>
      <el-col :span="24"
        ><div class="grid-content bg-purple-dark storageBox">
          <p>申请管理>教学设备借入申请</p>
          <div class="baikuang">
            <p class="rukus">教学设备借入申请记录</p>
            <p>
              <el-badge class="item">
                <el-button size="small" class="tianjia" @click="tiao()"
                  >发起借入申请</el-button
                >
              </el-badge>
              <span class="ruku">借出时间:</span>
              <el-date-picker
                v-model="value1"
                type="date"
                placeholder="选择日期"
...
import JiaoTable from "../../../components/shenqingTable/jiaoTable";
export default {
  components: {
    Header,
    JiaoTable,

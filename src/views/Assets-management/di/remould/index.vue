        ...
        ><div class="grid-content bg-purple-dark storageBox">
          ...
          <div class="baikuang">
            ...
            <el-button type="text" @click="dialogFormVisible = true">
              <el-button type="danger"  class="tianjia">+新增改造</el-button>
            </el-button>
            <el-input v-model="input" class="input2" placeholder="请输入编码或名称"></el-input>
            <el-dialog
              title="新增改造"
            ...
            >
              ...
              <RemouldTableTow></RemouldTableTow>
              <p style="margin-top: 10px">
                <span class="ruku">改造时间:</span>
                <el-date-picker
                  v-model="value5"
                  type="date"
                  placeholder="选择日期"
...
import RemouldTable from "../../../../components/diTable/remouldTable";
import RemouldTableTow from "../../../../components/diTable/remouldTableTow";
export default {
  components: {
    Header,
    RemouldTable,
